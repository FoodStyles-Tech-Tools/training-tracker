...
async function main() {
  console.log("Generating VPA and VSR waitlist test data...");
  ...
  // Create VPAs and VSRs with different statuses and dates
  ...
  console.log("\n✅ VPA and VSR waitlist test data generated successfully!");
...
main()
  .catch((error) => {
    console.error("Error generating VPA and VSR waitlist test data:", error);
    process.exit(1);
  })
  .finally(() => {
    process.exit(0);
